  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path={"/service"}
          element={<Service headerText={"Services"} />}
        />
        <Route
          path={"/contact"}
          element={<Contact headerText={"Contact Us"} />}
        />
        <Route
          path={"/pages/feature"}
          element={<Feature headerText={"Feature"} />}
        />
        <Route
          path={"/pages/appointment"}
          element={<Appointment headerText={"Appointment"} />}
        />
        <Route path={"/pages/team"} element={<Team headerText={"Team"} />} />
        <Route
          path={"/pages/testimonial"}
          element={<Testimonials headerText={"Testimonial"} />}
        />
